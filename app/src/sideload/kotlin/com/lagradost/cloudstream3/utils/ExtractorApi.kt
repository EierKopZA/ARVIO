...
enum class ExtractorLinkType {
    /** Single stream of bytes no matter the file type */
    VIDEO,
...
val extractorApis: MutableList<ExtractorApi> = arrayListOf(
    ...
    // removed (newpipe dep): YoutubeExtractor(),
    // removed (newpipe dep): YoutubeShortLinkExtractor(),
    // removed (newpipe dep): YoutubeMobileExtractor(),
    // removed (newpipe dep): YoutubeNoCookieExtractor(),
    Streamlare(),
    VidSrcExtractor(),
    VidSrcExtractor2(),
    VidSrcTo(),
